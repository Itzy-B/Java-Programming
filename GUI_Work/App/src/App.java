...
public class App extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        // Main game sound
        String musicFile = "App/Sound/Main_Game.mp3";
        Media sound = new Media(new File(musicFile).toURI().toString());
        MediaPlayer mainGame = new MediaPlayer(sound);
        mainGame.setVolume(0.2);

        // High Score
        String musicFile2 = "App/Sound/Hotlanta - Track Tribe.mp3";
        Media sound2 = new Media(new File(musicFile2).toURI().toString());
        MediaPlayer highScore = new MediaPlayer(sound2);
        highScore.setVolume(0.2);
