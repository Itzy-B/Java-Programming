...
public class JavaCraft {
  ...
  private static final int whiteRussiaFlag = 5;
  ...
  private static boolean secretDoorUnlocked = true; // true or false to the unlock mode (secret doo)
